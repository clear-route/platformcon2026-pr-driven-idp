...
> restarting appsets:
```
kubectl annotate applicationset platformcon2026-preview-appset -n argocd argocd.argoproj.io/refresh=normal --overwrite
kubectl annotate applicationset platformcon2026-onboarding-appset -n argocd argocd.argoproj.io/refresh=normal --overwrite
```
